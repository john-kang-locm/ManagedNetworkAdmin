...
namespace ConfigurationAdminTool.Api.Controllers
{
    ...
    public class SiteSettingsController : ConfigurationAdminToolDataController
    {
        ...
        /// </summary>
        /// <returns>IEnumerable&lt;ConfigurationAdminTool.Data.Models.SiteSetting&gt;</returns>
        [AcceptVerbs("GET", "POST")]
        ...
        /// <returns>ConfigurationAdminTool.Data.Models.SiteSetting</returns>
