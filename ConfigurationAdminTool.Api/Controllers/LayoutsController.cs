...
namespace ConfigurationAdminTool.Api.Controllers
{
    ...
    public class LayoutsController : ConfigurationAdminToolDataController
    {
        ...
        /// </summary>
        /// <returns>IEnumerable&lt;ConfigurationAdminTool.Data.Models.Layout&gt;</returns>
        [AcceptVerbs("GET", "POST")]
        ...
        /// <returns>ConfigurationAdminTool.Data.Models.Layout</returns>
