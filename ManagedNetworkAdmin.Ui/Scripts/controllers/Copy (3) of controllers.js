...
angular.module('app.controllers', ['ngGrid', 'ngSanitize', 'app.factories', 'app.directives', 'app.services', 'ui.bootstrap'])
.controller('ModalInstanceCtrl', ['$scope',   function ($scope ) {
    ...
    .controller('ExistingLayoutCtrl', function ($scope, $http, $modal, apiService, apiFactory, $location, $window) {
        $scope.layout = {};
        $scope.layoutData = [];
        ...
        $scope.existingLayoutGridOptions =
            {
                ...
                afterSelectionChange: function () {
                    $scope.sites.Layout = $scope.selectedLayout[0];
                },
                jqueryUITheme: true,
  ...
  //{ field: "Name", pinned: true },
    ...
    .controller('SiteController', function ($scope, $http, $modal, apiService, apiFactory, $location, $window) {
        $scope.selectedSite = {};
